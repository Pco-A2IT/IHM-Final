<!-- Page divisée en 5 onglets :
1.	La liste des patients pour lesquels il faut planifier des examens
2.	La liste des patients pour lesquels il vaut vérifier la réalisation d'un examen
3.	La liste des patients pour lesquels l'ensemble des examens ont été planifiés
4.	La liste des patients pour lesquels il faut vérifier que tous les examens nécessaires avant un rendez-vous neurologique ont bien été réalisés
5.	La liste des patients ayant réalisé l'ensemble des examens.
Pour les onglets 3 et 5 des récapitulatifs peuvent être téléchargés pour les patients au format pdf. -->
                                                ...
                                                <table cellspacing="0px" id="tbl" class="table" >   
                                                    ...
                                                    <tr>                                        
                                                        ...
                                                        <?php 
                                                                    ...
                                                                    if($dnn2["date_examen"]=="1970-01-01"){ 
                                                        ?>
                                                        ...
                                                        <form action="./Interaction-BDD/ModifBDD_Suivi_Examens.php?id_patient=<?php echo $dnn1["id_patient"];?> &amp; name_checkbox= <?php echo $cmpt1;?> &amp; id_examen=<?php echo $dnn2["id_examen"];?>" method="post">                                               
                                                            <td>
                                                                <input type="checkbox" class="regular checkbox" name="<?php echo($cmpt1);?>" value="YES"/>
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="liste">
                                                ...
                                                <table cellspacing="0px" id="tbl" class="table">   
                                                    ...
                                                    <tr>                                                        
                                                        ...
                                                        <td>
                                                            <?php echo $dnn2['prenom_m'].' '.$dnn2['nom_m']; ?>
                                                            <br>
                                                        ...
                                                        <td>
                                                            <?php echo $dnn3['prenom_m'].' '.$dnn3['nom_m']; ?>
                                                            <br>
                                            ...
                                            <div class="liste">
                                                ...
                                                <table cellspacing="0px" id="tbl" class="table">   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo strftime("%d/%m/%Y",strtotime($dnn1['date_creation_dossier'])); ?></td>
                                                        <td>
                                                            <a href="./ExportPdf/ExportExamRealise.php?id_patient=<?php echo $dnn1["id_patient"];?>"> 
                                                                <img class="icone_liste" src="Icones/icon_pdf.png" width="60px" heigh="60px"/>
                                                            </a>                                              
                                                        </td>
