...
{       
    if($_POST['centre_s']==''){$centre_s= $donnees['centre_s'];}//s'il ne l'est pas la variable prend la valeur déjà existante dans la bdd
    else{$centre_s=$_POST['centre_s'];}//si le champ est rempli on modifie la bdd
    echo $centre_s;
