...
//il faut trouver l'id du medecin correspond
    ...
    if($test!=true){
        $reqmt = $bdd->prepare('INSERT INTO medecin(id_medecin ,id_service, nom_m, prenom_m, mail_m, ville_m, codePostal_m, adresse_m, telephone_m) VALUES(NULL ,0,?,?,?,\'\',\'\',\'\',\'\')');
...
if($nom_m_appelant!="" && $prenom_m_appelant!="" ){
    ...
    if($test2!=true){
        //s'il n'existe pas on le crée en renseignant juste le minimum
        $reqmu = $bdd->prepare('INSERT INTO medecin(id_medecin ,id_service, nom_m, prenom_m, mail_m, ville_m, codePostal_m, adresse_m, telephone_m) VALUES(NULL ,0,?,?,?,\'\',\'\',\'\',\'\')');
