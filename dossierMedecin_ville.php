<?php
    ...
    $requete = $bdd->prepare('SELECT ville_m, codePostal_m FROM medecin WHERE ville_m LIKE :nom'); // requête SQL : on choisit les services dont le nom commence par le terme saisi
