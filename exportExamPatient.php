<!-- fichier permettant l'export les données de la table des liens entre patients et examens ; appelé depuis la page Parametres_Export.php -->
...
<?php
    ...
    $objPHPExcel->getActiveSheet()->setTitle('ExamenPatient'); // on nomme la feuille excel 'ExamenPatient'    
    $objPHPExcel->setActiveSheetIndex(0); 
