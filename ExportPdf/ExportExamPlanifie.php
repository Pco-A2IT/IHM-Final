...
$pdf->AddPage("L");
 // Police Arial gras 15
    ...
    $pdf->Cell(100);
    // Titre
    $pdf->Cell(70,10,'Planification des examens',1,0,'C');
    // Saut de ligne
    $pdf->Ln(20);
    //descriptif
    $pdf->Cell(40,10,'Tableau récapitulatif de l\'ensemble des examens planifiés pour le patient '.$patientPrenom." ".$patientNom." :");
$pdf->Ln(15);
// Titres des colonnes
$header = array('Examen', 'Centre', 'Service', 'Date','Heure');
