...
$reqExam=$bdd->prepare('SELECT * FROM examen_patient,examen,service,patient WHERE examen.id_examen=examen_patient.id_examen AND examen_patient.id_service=service.id_service AND patient.id_patient=examen_patient.id_patient AND examen.typeExamen="Angioscan" AND patient.id_patient=?');
