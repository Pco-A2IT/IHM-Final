...
?>
    ...
    <tr>
        ...
        <td><a href="./Interaction-BDD/SupprBDD_Service.php?idservice=<?php echo $dnn['id_service']; ?>" onclick="javascript:confirm(id_service)"><img class="supprimer" src="Icones/button_supprimer.png"></a></td>
