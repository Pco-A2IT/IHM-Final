...
?>
    ...
    <tr>
        ...
        <td><a href="javascript:if(confirm('确实要删除吗?')) location='./Interaction-BDD/SupprBDD_Service.php?idservice=<?php echo $dnn['id_service']; ?>'"><img class="supprimer" src="Icones/button_supprimer.png"></a></td>
