...
?>
    ...
    <tr>
        ...
        <td><a href="./Interaction-BDD/SupprBDD_Service.php?idservice=<?php echo $dnn['id_service']; ?>" onclick="return confirm('确认要删除?')"><img class="supprimer" src="Icones/button_supprimer.png"></a></td>
