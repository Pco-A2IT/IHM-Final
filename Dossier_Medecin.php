    ...
    <body>
        ...
        <div>
            <div class="blanc";   style="border-radius: 5px;">
                 ...
                 <input type="submit" accesskey="enter" value="Valider" onmousemove="changeBgColor('btn')" onmouseout="recoverBgColor('btn');" class="submit position_submit" style="align:left;" id="btn" formmethod="post" /> 
                <div class="section4">
                    <div class="div1">
