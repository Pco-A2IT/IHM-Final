    ...
    <body>
        ...
        <div>
            <div class="blanc";   style="border-radius: 5px;">
                 ...
                 <input src="Icones/valider_blanc.png" type="submit" accesskey="enter" value="Valider" onmousemove="changeBgColor('btn')" onmouseout="recoverBgColor('btn');" class="submit position_submit" id="btn" formmethod="post" /> 
                <div class="section4">
                    <div class="div1">
