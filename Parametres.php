<!-- Page affichant les différents outils de la plateforme sous forme de boutons liés aux pages détaillant chaque paramètre (gestion des examens, export des données et changement de mot de passe). -->
