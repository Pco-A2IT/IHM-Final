...
<?php
    ...
    if (isset($_POST['envoye'])) {
        ...
        if (get_magic_quotes_gpc()) {
          ...
          $expediteur	= stripslashes(trim($_POST['email_m']));
          $sujet		= stripslashes(trim($_POST['sujet']));
          $message		= stripslashes(trim($_POST['message']));
        }
        else {
          $civilite		= trim($_POST['civilite']);
          $nom		    = trim($_POST['nom_m']);
          $expediteur	= trim($_POST['email_m']);
        ...
        * vers la page d'accueil */
        ...
        elseif (empty($civilite) || empty($nom) || empty($expediteur) || empty($sujet) || empty($message)) {
...
<html lang="fr">
    ...
    <form action="send_email.php" method="post">
        ...
        <p>
            <label for="nom_m">Nom/Prénom :</label>
            <input type="text" id="nom_m" name="nom_m" 
                value="<?php echo (isset($_POST['nom_m'])) ? $nom : '' ?>" 
            />
        </p>
        <p>
            <label for="email_m">E-mail :</label>
            <input type="text" id="email_m" name="email_m" 
                value="<?php echo (isset($_POST['email_m'])) ? $expediteur : '' ?>"
            />
        </p>
        <p>
