                    ...
                    <div class="blanc";   style="border-radius: 5px;">
                        <div class="section4">
                            ...
                            <div id="divConteneur3">
                                ...
                                <input type="submit" accesskey="enter" value="Suivant" onmousemove="changeBgColor('btn')" onmouseout="recoverBgColor('btn');" class="submit position_submit" formmethod="post"/> <?php echo $_GET['id_patient'];?>                       
                            </div>                    
                        </div>
                    </div>
                    <script>
